        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 xl:gap-10 py-4 xl:py-10">
            <div className={cn("flex justify-center items-center relative", project.images.length > 1 && "min-h-[300px] xl:min-h-[500px]")}>
                {project.images.length > 1 ? <>
                    <Image className="object-cover absolute left-0 xl:left-20 top-10 w-[85%] xl:w-2/3 hover:scale-[1.2] hover:z-10 aspect-video rounded-lg border border-primary transition-all" src={project.images[0].url} height={1000} width={1000} alt={"Open United"} />
                    <Image className="object-cover absolute right-0 xl:right-20 bottom-10 w-[85%] xl:w-2/3 hover:scale-[1.2] aspect-video rounded-lg border border-primary transition-all" src={project.images[1].url} height={1000} width={1000} alt={"Open United"} />
                </> : <>
                    <Image className="object-cover aspect-video xl:aspect-auto border border-primary" src={project.images[0].url} height={500} width={500} alt={"Open United"} />
                </>}
            </div>
            <div className="flex flex-col xl:gap-4 justify-center items-center xl:items-start">
                ...
                <div className="flex items-center flex-wrap gap-y-2 gap-x-2 xl:gap-x-4 justify-center xl:justify-normal">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 w-full gap-3 mt-2 xl:mt-10 ">
