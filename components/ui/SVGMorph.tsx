...
const SVGMorph = () => {
    ...
    return (
        <motion.svg variants={imageVariants} initial="initial" animate="animate" className="w-fit h-fit xl:w-[30rem] xl:h-[30rem] p-5 xl:p-0 relative" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="image" x="-0.25" y="-0.3" height="150%" width="150%" viewBox="0 0 1 1">
            ...
            <path className=" stroke-primary stroke-1" fill="url(#image)" transform="translate(100 100)" >
