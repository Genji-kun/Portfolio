...
const HomePage = () => {
  return (
    ...
    <div className="min-h-screen flex flex-col relative">
      <svg aria-hidden="true" className="-z-10 absolute -top-[40vh] right-0 w-1/4 h-1/4 blur-3xl" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
